...
//             <div className="sticky top-24 max-h-[calc(100vh-7rem)] overflow-y-auto rounded-2xl border border-white/10 p-5 backdrop-blur">
...
//                   className="rounded-xl border border-white/15 px-3 py-2 text-sm font-semibold text-white/80 transition hover:border-[#a8ff35]/50 hover:text-[#a8ff35] lg:hidden"
//                 >
//                   Filtres
//                 </button>
    ...
    <div className="min-h-screen mt-14 bg-black text-white">
          ...
          <div className="min-w-0 flex-1">
            ...
            {query.isError ? (
              ...
              <>
                ...
                {!hasNextPage && (
                  <p className="mt-8 py-4 text-center text-sm text-zinc-600">
                    Vous avez vu tout le catalogue
                  </p>
                )}
              </>
              ...
              <EmptyState
                title="Aucun produit ne correspond"
                message="Essaie d'élargir ton budget ou de retirer quelques filtres."
      ...
      >
        <div className="mb-6 flex items-center justify-between border-b border-white/10 pb-4">
          <span className="text-lg font-bold text-white">Filtres</span>
          <button
            type="button"
            onClick={() => setSideOpen(false)}
