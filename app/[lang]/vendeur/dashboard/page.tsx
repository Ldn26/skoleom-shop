      ...
      <div className="mx-auto max-w-[1400px]">
        ...
        <div className="rise mb-7 flex flex-wrap items-end justify-between gap-4">
          <div>
            ...
            <h1 className="mt-1 font-extrabold tracking-tight" style={{ fontSize: 30 }}>
              Tableau de bord
            </h1>
            <p className="mt-1" style={{ fontSize: 13.5, color: C.w50 }}>
              Vue d’ensemble de votre boutique · Septembre 2026
            </p>
          </div>
          <button
        ...
        <div className="mb-6 grid grid-cols-1 gap-4 xl:grid-cols-3">
          ...
          {/* stock donut */}
          <div
            className="rise card rounded-3xl p-6"
            style={{
              background: C.panel,
          ...
          >
            ...
            <p className="mb-2" style={{ fontSize: 12.5, color: C.w50 }}>
            ...
            <div className="relative" style={{ height: 210 }}>
              ...
              <div className="pointer-events-none absolute inset-0 flex flex-col items-center justify-center">
                <span
                  ...
                  style={{ fontSize: 30, color: C.lime, lineHeight: 1 }}
                >
                  {inStockPct}%
                </span>
...
function StatCard({
  ...
  return (
    <div
      className="rise card rounded-3xl p-5"
      style={{ background: C.panel, border: `1px solid ${C.border}`, animationDelay: `${delay}ms` }}
    >
      <div className="flex items-start justify-between">
        <div
          className="grid place-items-center rounded-2xl"
          style={{ width: 44, height: 44, background: C.limeDim, color: C.lime }}
        >
          <Icon size={20} />
        </div>
        <span
          ...
          style={{
            fontSize: 11,
            background: up ? C.limeDim : 'rgba(248,113,113,0.12)',
            color: up ? C.lime : C.red,
          }}
        >
      ...
      <p
        ...
        style={{ fontSize: 10.5, letterSpacing: '0.16em', color: C.w40 }}
      >
        {label}
      </p>
      <div className="mt-0.5 flex items-end justify-between gap-2">
        <p className="font-extrabold" style={{ fontSize: 24 }}>
          {value}
        </p>
